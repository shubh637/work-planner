# Work Planner (This project was originally developed on an internal SAP GitHub account. Since that repository is private and not publicly accessible, the code has been uploaded to this public GitHub account as a single commit to make it available for review.)
